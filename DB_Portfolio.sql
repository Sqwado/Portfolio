...
-- Listage des données de la table portfolio.Admin : ~1 rows (environ)
INSERT INTO `Admin` (`id_admin`, `email`, `password`) VALUES
	(1, 'test@test.fr', '$2y$14$2HcNrjkREU.aOIAV918zG.9plY/n.zGi8cPTxr7p65eaSU3Y6PJgW');
...
-- Listage des données de la table portfolio.Article_categorie : ~4 rows (environ)
...
-- Listage des données de la table portfolio.Categorie : ~10 rows (environ)
...
-- Listage des données de la table portfolio.Message : ~7 rows (environ)
...
-- Listage des données de la table portfolio.Project : ~5 rows (environ)
...
-- Listage des données de la table portfolio.Project_categorie : ~6 rows (environ)
